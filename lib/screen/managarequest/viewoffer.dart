...
import 'package:cowdiar/util/viewoffer.dart';
...
class viewoffer extends StatefulWidget {
  ...
  const viewoffer(this.orderid, {super.key});
  @override
...
class _viewofferState extends State<viewoffer> {
  ...
  Future<Null> getData() async {
    ...
    if (responseData.statusCode == 200) {
      ...
      var offerdetails = jsonDecode(data)['content']['rDetails'] as List;
      var productdetails = jsonDecode(data)['content']['oDetails'] as List;
      print(offerdetails);
      setState(() {
  ...
  Widget build(BuildContext context) {
    ...
    child: const Center(child: Text("View Offers"))
    ),
    ),
    body: ListView(
    children: <Widget>[
        ...
        Container(
              color: Colors.white,
              padding: const EdgeInsets.only(bottom: 10, top: 8.00),
              //alignment: FractionalOffset(1.0, 1.0),
              width: MediaQuery.of(context).size.width,
                                        ...
                                        Column(
                                          children: <Widget>[
                                            Container(
                                                ...
                                                child: const Center(child: Text("Request Description"))
                                            ),
                                            Row(
                                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                              children: <Widget>[
